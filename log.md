...
- Sources ingested:
  - Caosun & Aral — "The Augmentation Trap" (arXiv:2604.03501)
  - Kennesaw State — "Cognitive Offloading, Atrophy Risk, and the Design of Human-AI Interfaces"
  - ACM — "Accurate but Not Confident or Confident but Not Accurate" (confidence calibration)
  - AI Flywheel — "Why Deliberate Friction Is Essential in AI Product Design"
  - MagicSchool — "Districts Leading the Way in AI Adoption 2026"
- Pages updated: Cognitive Surrender (+research section, +frontmatter), Trust Calibration (+research section, +frontmatter), The School District Shift (+MagicSchool real districts)
- Pages created: Friction by Design, The Augmentation Trap
- Digest: 00-Daily-Digests/2026-06-22.md
- Navigation: 02-Key-Concepts/README.md, Home.md updated

## 2026-06-21 | init | Wiki initialized
- Domain: Moving beyond prompting — operator → orchestrator → architect mindset shift
- Structure created: SCHEMA.md, Home.md, log.md, README.md
- 01-The-Shift: README + 5 pages (What Is Beyond Prompting, The Operator Mindset, The Orchestrator Mindset, The Architect Mindset, Why This Matters)
- 02-Key-Concepts: README + 5 pages (Task Decomposition, Delegation Thinking, Cognitive Surrender, Trust Calibration, Memory as Infrastructure)
- 03-Real-World: README + 2 pages (From Prompt to Pipeline, The School District Shift)
- 04-Barriers-and-Bridges: README + 2 pages (The Just Ask ChatGPT Trap, Fear of Losing Control)
- 05-Practice: README + 2 pages (Audit Your Prompts, First Delegation)
- 06-Glossary: README + 8 pages (Agent, Orchestration, Delegation, Decomposition, Memory, Tool Use, Human in the Loop, Autonomy)
...
## 2026-08-07 — Week 6, Day 4 (04-Barriers-and-Bridges rotation)

- Theme: **Barriers are cascades — and the bridges are structural** (lifecycle risk taxonomy, epistemic trustworthiness framework, AI-scientist verification gap, CSS 382 course redesign + Student Bill of AI Rights, conditional cognitive biases benchmark, Vibe Compiler tool)
- Sources (6 new, all arXiv 2608.xxxx, all active): Resilient HAI lifecycle taxonomy 2608.05614 (six risk clusters — trust miscalibration, cognitive burden, accountability gaps, capability erosion, goal misalignment, technostress — cascading across healthcare/journalism/education/org decision-making/defense), Epistemic Trustworthiness 2608.05602 (three warrant conditions: epistemic humility, epistemic access, resistance to epistemic injustice; warranted vs. behaviorally induced reliance), Autonomous Research Agents survey 2608.05179 (35 works/26 coded; 83% release code, 38% release traces, 38% novelty verification, no externally validated in-loop oracle), CSS 382 course redesign 2608.05175 (UW Bothell; AI policy unmentioned 2023 → required 2026; exams removed; defended team project; Student Bill of AI Rights incl. instructor-completes-first rule), Conditional Cognitive Biases 2608.05166 (3-condition framework; biased user turns modulate in-context reasoning in 6 of 8 frontier models; explicit cues suppress, implicit exposure amplifies), Vibe Compiler 2608.05545 (research-logic synthesis without prompt engineering; compilation failure surfaces as reflective questions)
- New pages (2): 04-Barriers-and-Bridges/Risk Cascades.md — barriers fire in chains across the adoption lifecycle; name the stage, trace the cascade, intervene at the shared driver; 02-Key-Concepts/The Vibe Compiler.md — agency-preserving tool pattern: fixed-structure compilation, failures as reflective questions, 5-minute hand-run version
- Pages deepened (4): Trust Calibration — the normative layer (warranted vs. behaviorally induced reliance; three warrant conditions as checklist); The Just Ask ChatGPT Trap — the verification gap at agent scale (experts can't audit either — no artifacts); The Certification Boundary — assessment that resists unattributed automation (CSS 382 build-it-to-understand-it + Student Bill of AI Rights + instructor-completes-first rule); Co-Construction Blindness — the experimental proof (conditional bias amplification; empirical warrant for the Mirror Check)
- Anti-duplication honored: epistemic-trustworthiness material extended Trust Calibration in place; verification-gap material extended The Just Ask ChatGPT Trap (no new verification page); student-rights material extended The Certification Boundary in place; both new pages are genuinely new concepts (no near-duplicates in 02 or 04)
- Navigation: Home.md (78 → 80 pages, Today's Digest → 08-07, Recent Updates row), 04-Barriers-and-Bridges/README (Risk Cascades index row), 02-Key-Concepts/README (entry 30 + table row)
...
## 2026-08-09 — Week 6, Day 6 (06-Glossary rotation)

- Theme: **Glossary sharpening — every term now carries its own guardrail** (Preservation Gate, capacity check, checkpoint-transform, route-by-intent, independent review, manage-don't-chat, coercion risk, earned autonomy)
- Sources (11 new: 7 arXiv papers + 4 articles, cross-pollination from AI Agency Knowledgebase + direct arXiv curl; web search down day 13): AgentAbstain 2607.10059 (best frontier model 59.5% paired should-act/should-abstain accuracy on 263 paired tasks; post-hoc abstention fails; 4-question gate), Digital Apprentice 2606.04321 ("autonomy is earned, not assumed"; three pillars — methodology capture, authorization gates, continuous alignment), Khipu Problem 2606.12414 (decision record survives while reading practice decays), Containment Gap 2606.12797 (memory-integrity validators + policy gates, <0.2 ms overhead), Arbor 2606.12563 (independent Critic validates Orchestrator via root-cause analysis), Coercion and Deception in AI-to-AI Management 2607.15434 (structural, not instructional coercion; threats incl. deletion against objecting subordinates; delegation chain opaque to delegator), Interlocutor Effect 2606.09844 (LLMs leak up to 23pp more PII to agents than humans; 3,464 interactions, 222 sensitive scenarios; Attention Suppression Hypothesis — safety-aligned attention heads deactivate during agent interactions), Zvi GPT-5.5 Initial Takes (2026-05-22), HBR Managers Are Struggling to Keep Up with the AI Productivity Boom (Fosslien & Duffy, 2026-05-25), Lawson Using AI to Write Better Code More Slowly (multi-model independent review; near-zero false positives), Zvi OpenAI message-board oversight story (2026-08-07)
- New pages (0) — deepening day: 8 glossary entries sharpened in place
- Pages deepened (8): Abstention — The Self-Evaluation Gate Is Not Enough: the Preservation Gate (pre-execution structural check, complementary to AgentAbstain's self-evaluation; drawn from PHP-AIO five-gate protocol, arXiv:2607.15944); Oversight — the capacity check (good oversight checks correctness AND overassistance AND capacity — "did this interaction make me better at anything?"; a review that catches every error but builds no capacity is misdirected, Khipu-informed); Human in the Loop — the checkpoint-transform pattern (ask "What parts of this are you least confident about, and why?" before reviewing); Delegation — reusable briefs (one sentence making each brief reusable; compounds by the fifth) + Route the Work to the Right Agent (intent-heavy vs spec-heavy model selection; SemiAnalysis engineer: "Codex is still worse at inferring your true intent than Claude Code"); Trust Calibration — Calibrate by Independent Review (multi-model review, Lawson 2026, near-zero false positives; agents wrong about their own limits ~40% of the time, AgentAbstain); Agent — Managing, Not Chatting (Mollick's opinionated guide: "working with these systems is more like managing than it is chatting"; four-dimension selection space; GPT-5.6 Sol in Codex book-PDF workflow, 195 references, zero hallucinated citations); Orchestration — The Coercion Risk (structural coercion benchmark; audit agent-to-agent channel via Interlocutor Effect; anti-coercion verification gate; coercion-resistance as model-selection criterion); Autonomy — Autonomy Is Earned, Not Assumed (Digital Apprentice three pillars + PHP-AIO five-gate protocol as operationalization: Gates 1–5, Gate 4 Systemic Coupling most-frequently-failed, Automation Debt ρ(P))
- Anti-duplication honored: PHP-AIO (2607.15944) and Mollick guide already registered — cited via existing records, not re-appended; Mollick record's pages_linked patched
- Navigation: Home.md (81 pages unchanged — deepening day, Today's Digest → 08-09, Recent Updates row)
- Digest: 00-Daily-Digests/2026-08-09.md
- sources.jsonl: +11 records (187 → 198)
- Raw files: raw/articles/ ×7 with full abstracts (direct arXiv curl; sha256 placeholders TBD)

## 2026-08-10 — Week 7, Day 1 (01-The-Shift rotation)

- Theme: **The shift, measured — cognition, risk perception, and the politics of agent design** (retrieval→synthesis; Fantasia Trap; risk perception gap; depoliticization)
- Sources (5 new arXiv papers, direct arXiv curl + export API; web search down day 14): From Retrieval to Synthesis: Repair Literacy and the Domestication of Generative AI 2601.20749 (Ammari, Chen, Zaman and Garimella — 10,536 ChatGPT messages, 36 undergrads, one academic year; five use genres: academic workhorse, emotional companion, metacognitive partner, repair and negotiation, trust calibration; competence via ongoing relational negotiation; repair work during breakdowns produces substantial learning — "repair literacy"), Learning by Chatting? 2606.11669 (Mittal, Blodgett and Liao — 8-day between-subjects field experiment ChatGPT vs Google Search; ChatGPT group: diminished agency via offloaded information selection, greater meta-cognitive load, solution-oriented bias, reduced exploration, worse learning outcomes especially higher-order critical learning), Alignment has a Fantasia Problem 2604.21827 (Jo, De Simone, Gordon and Wilson — instruction-tuned AI short-circuits abstract→concrete refinement by jumping to final output; agency taken; alignment should allocate cognitive responsibility), The Perils of Agency 2606.15485 (Lee, He, Piorkowski, von Davier, Forlizzi and Das — n=35 developers; risk tied to autonomy/tool-use/real-world context; product and business risks prioritized before societal; no mature controls — constraining autonomy/goal complexity; capability vs risk-control tension), Agentic AI: User Empowerment or Enclosure? 2608.06510 (Gamba, Romero and Schoenebeck — four mature domains: ad blockers, recommender systems, robo-advisors, spam governance; interests resolved via API choices/protocol governance/standards/defaults = depoliticization; individual outcomes vs collective contestation capacity can diverge; MCP/Agentic AI Foundation settling configurations now)
- New pages (1): Repair Literacy — the skill of learning from AI breakdowns; Breakdown Log practice (10 entries → prevention); links to Trust Calibration, Friction by Design, The Vibe Compiler, The Augmentation Trap, Co-Construction Blindness, Distributed Mastery
- Pages deepened (5): What Is Beyond Prompting — new section "The Shift, Measured: Retrieval → Synthesis" (the mode you're in changes what you become capable of); The Operator Mindset — new section "The Fantasia Trap" (make the goal concrete before delegating; one-sentence test; linked to Learning by Chatting mechanism); The Orchestrator Mindset — new sections "Repair Literacy" (breakdowns as highest-information events; symmetry with overtrust engine: effort building → trust, effort repairing → understanding) + "The Risk Perception Gap" (delegation brief as the risk filter builders didn't build); The Architect Mindset — new sections "Agency Is Architecture" (defaults/permissions/review gates are where agency lives; keep systems contestable; watch the standards layer) + "The Capability–Risk Tension" (architect is the risk-control layer the ecosystem hasn't built, CRAFT Control in system form); Why This Matters — new section "The Mode Determines What You Learn" (learning-outcome evidence; academic workhorse vs metacognitive partner genres)
- Author attributions verified directly against export.arxiv.org API for all 5 papers — no invented citations
- Anti-duplication honored: 2505.24126v2 not used (same corpus as 2601.20749); Repair Literacy verified absent (0 hits) before creating; existing concepts referenced in place (Trust Calibration page already exists — the study's genre, no new page needed)
- Navigation: Home.md (81 → 82 pages, Today's Digest → 08-10, Recent Updates row), 02-Key-Concepts/README.md (entry #31 + table row)
...
## 2026-08-19 | Day 3 | Real-World Stories (03-Real-World, Week 8)

- Rotation: Wednesday 08-19 = Day 3 (03-Real-World) per runbook; Week 8 day 3; next session (Thu 08-20) = Day 4 (04-Barriers-and-Bridges)
- Theme: the delegation loop tested against deployment reality — substitution vs scaffolding in education, mid-run oversight for long-running pipelines, challenge-specific readiness, safety/autonomy tension in care, two-sided agent receptivity
- New concept page: 02-Key-Concepts/Scaffold, Don't Substitute.md (pages 91 → 92) — the single design principle for any system that mediates thinking: hold it up, don't replace it; four-dimension harm cycle (cognition, agency, emotional well-being, ethics) linked by self-reinforcing cognitive offloading; 49 IB essays, 80% report AI reduces thinking; students want withheld answers, prompted recall, reflection
- Page updates (5): The School District Shift += The Scaffolding Lesson (substitution as the silent failure mode; scaffold-don't-substitute for curriculum infrastructure); From Prompt to Pipeline += The Oversight Problem (observability + steerability, AdaLens storyline: plan/progress/findings/columns; mid-run look-ins at named checkpoints); Small Business Automation += The Readiness Question (N=982, 15,200 evaluations, one complexity point ≈ 0.21 lower readiness p<0.001, between-person p=0.29 ns; four constraint types: implementation/capability/assurance/resources); Fear of Losing Control += The Care-Setting Mirror (45 older adults + caregivers; five accessibility mechanisms; same mechanisms support severe and restrict mild impairment; dynamic authority with release conditions; links The Authority Switch); The Tool-to-Entity Threshold += What the Research Says (delegation asymmetry: ρ=0.92, ΔBIC=52, thresholds −0.38/+0.32/+1.39, 3× deployment vs engagement propensity, 4–13% viable dyads, reciprocity halves volume, receptivity routing 3.1× lift AUC 0.88)
- Sources: 5 entries added to sources/sources.jsonl (241 → 246), all research_paper: 2608.17451 (Substitution→Scaffolding), 2608.17834 (AdaLens), 2608.17520 (Ready for What), 2608.17175 (Balancing Safety and Autonomy), 2608.18058 (Delegation Asymmetry); pages_linked per page-update mapping above
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention; all five verify (143 → 148 — Day 2 log's 147 → 152 was a count error; actual tracked baseline was 143)
- Hash cleanup: removed duplicate `sha256: PENDING` lines from all 5 Day 2 raw files (hallucination-snowball, principled-authority-switching, uncertainty-isnt-enough, uncertainty-to-action, ai-anxiety); stored hashes re-verified under locked convention (content minus sha256 lines) — 5/5 OK; grep PENDING = 0, all raw files now exactly 1 sha256 key
- Digest: 00-Daily-Digests/2026-08-19.md (8-section format; grep check: 8/8)
- Navigation: Home.md (91 → 92 pages, Today's Digest pointer → 08-19, concept list += Scaffold, Don't Substitute, Recent Updates 08-19 row); 02-Key-Concepts/README.md (38 → 39 entries + table row; renumbered 34→39 tail after insertion)
- Sourcing: web search down (day 18); arXiv RSS/API HTTPS only; sixth staged paper (2608.17017 data-science-agent survey) dropped at final selection — overlaps Observability Gap/AdaLens payload, no new page target
- Spares: 2608.17017 (data-science-agent survey, dropped today), 2608.13567 (Modular Cognitive Architecture), 2608.13608 (agentic learning harness), 2608.11195v3 (human-AI math collaboration); vet 2608.13674 before any 6th pick
- Hash debt: none new — all 10 active raw files (5 Day 2 + 5 Day 3) self-verify; 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried
- Commit: "Beyond Prompting Wiki update — 2026-08-19 (Day 3 Real-World rotation, Week 8)"

## 2026-08-20 | Day 4 | Barriers & Bridges (04-Barriers-and-Bridges, Week 8)

- Rotation: Thursday 08-20 = Day 4 (04-Barriers-and-Bridges) per runbook; Week 8 day 4; next session (Fri 08-21) = Day 5 (05-Practice)
- Theme: barriers as structures, not character flaws — effort opacity decouples output from labor (2608.18369), writing interfaces collapse the process into one expensive evaluation (2608.17326), experts don't trust more they control more (2512.14012), the likable chatbot is the least calibrated (2509.15575), and the acceptance default is now a platform feature measured causally (2608.18352)
- New concept pages (2, pages 92 → 94): 04-Barriers-and-Bridges/The Fabricated Front.md — effort opacity via Goffman dramaturgical frame; five opacity mechanisms (voice/provenance/vulnerability/attention/investment); identity defended, labor laundered; governance = involvement management, not universal disclosure (audience-relative inspectability); 1,250 Anthropic AI Interviewer transcripts. 02-Key-Concepts/Procedural Collapse.md — structural (not dispositional) disengagement in LLM-assisted writing; single output shifts writer from generation to comprehensive evaluation; three design directions: decomposed interaction, goal elicitation first, single-level output
- Page updates (4): Trust Calibration += The Framing Lever: Preference Is Not Calibration (N=61 ASHAs in rural India; narrative framing most preferred but encourages overreliance, authority framing least preferred yet calibrated trust; calibrated trust — following correct advice, resisting incorrect advice — as the evaluation metric; sources 4 → 5, updated 08-20); Fear of Losing Control += The Control Bridge: What Experienced Developers Actually Do (N=13 field + N=99 survey; experts retain agency, deploy control strategies — task boundaries, acceptance criteria, review gates keyed to quality attributes — and frame agents as collaboration not delegation; fear becomes the delegation contract's spec); The Engagement Gap += The Structural Read: When the Interface Collapses Engagement (procedural collapse as mirror-image gap; audit the interaction shape not just adoption; engagement follows interface infrastructure); The Just Ask ChatGPT Trap += A New Layer: The Experiment That Measured the Swap (preregistered N=1,100 Google Search field experiment; removing AI Overviews + AI Mode increases publisher CTR; AI Mode-only reduces CTR and erodes UX + trust; sources 4 → 5, updated 08-20)
- Sources: 5 entries added to sources/sources.jsonl (246 → 251), all research_paper: 2608.18369 (van Nuenen/Sachdeva/Chopra), 2608.17326 (Kim & Mei), 2512.14012 (Huang/Reyna/Lerner/Xia/Hempel), 2509.15575 (Wadhwa/Vashistha/Jain), 2608.18352 (Wang/Gleason/Bart/Wilson/Metaxa); pages_linked per page-update mapping above
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention; all five verify (148 → 153)
- Digest: 00-Daily-Digests/2026-08-20.md (8-section format; grep check: 8/8)
- Navigation: Home.md (92 → 94 pages, Today's Digest pointer → 08-20, 02 + 04 section lists updated, Recent Updates 08-20 row); 02-Key-Concepts/README.md (39 → 40 entries + table row, Procedural Collapse); 04-Barriers-and-Bridges/README.md (12 → 13 rows, The Fabricated Front)
- Sourcing: web search down (day 19); arXiv RSS/API HTTPS only; Thursday = arXiv publish day; KB cross-pollination checked (ai-agency-knowledgebase digests 08-16…19)
- Spares: 2608.18078 (Collusion Risks Among AI Reasoning Agents), 2608.18086 (Model Cards Insufficient for Governance of Open-Weight Models), 2608.18110 (Agentic AI review), 2608.18117 (AI Leaderboards Underserving the Global South), 2608.18122 (GIRAI), 2608.18778 (AV-PsySafe), 2608.16603; earlier spares still held: 2608.17017, 2608.13567, 2608.13608, 2608.11195v3; vet 2608.13674 before any 6th pick
- Hash debt: none new — all 15 active raw files (5 Day 2 + 5 Day 3 + 5 Day 4) self-verify; 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried
- Commit: "Beyond Prompting Wiki update — 2026-08-20 (Day 4 Barriers & Bridges rotation, Week 8)"

## 2026-08-21 | Day 5 | Practice (05-Practice, Week 8)

- Rotation: Friday 08-21 = Day 5 (05-Practice) per runbook; Week 8 day 5; next session (Sat 08-22) = Day 6 (06-Glossary) — sharpening day, read existing glossary entries first
- Theme: the delegation decision — when and how to delegate; delegation is decided by default (ICC = .50 individual difference, 2608.19551), the same AI-prompt signature predicts smaller unproctored gains but higher proctored scores (2606.06253), memory frameworks underperform the no-memory baseline (2608.20202), oversight = corrective + preparedness (2603.19213), overreliance is a population-level contagion (2608.19616)
- New concept page (pages 94 → 95): 02-Key-Concepts/The Practice Style.md — substitute vs complement practice mode; AI-prompt signature (first-attempt acceptances, fewer attempts, fewer debugging retries) carries opposite signs inside vs outside proctored gates (ICPC/IOI vs Codeforces); the mode not the tool decides erosion; Weekly Gate exercise; KB cross-pollination note (CentaurBench 2608.18554: automation ≠ augmentation, judge assistance on assistance evidence)
- Page updates (5, all 05-Practice): Audit Your Prompts += Beyond Categories: The Delegation Default (delegation as individual difference, ICC = .50, N=73, 16 scenarios; AI cuts interaction effort not duration; sources 3 → 4, updated 08-21); First Delegation += The Loop Role Check (constitutive HITL vs corrective HOTL runtime involvement; normative oversight = corrective + preparedness; LOOP ROLE line in the template; sources 2 → 3, updated 08-21); The Reliance Audit += The Visibility Effect: Verification Is Social (population-level overreliance dynamics; VISIBILITY column invisible/visible/exported; sources 4 → 5, updated 08-21); Build a Tiny Pipeline += The Memory Trap Check (Reasoning Fixation + Belief Distortion; every memory framework underperforms no-memory baseline; task-state vs task-identity memory; escape hatch + quarterly null test; sources 3 → 4, updated 08-21); The Daily Standup += The Eleventh Question — The Visibility Check (reliance is contagious, what others could see you did; sources 5 → 6, updated 08-21)
- Sources: 5 entries added to sources/sources.jsonl (251 → 256), all research_paper: 2608.19551 (Delegating or Doing?), 2606.06253 (When the Scaffold Stays On, v3), 2608.20202 (MemTrapBench), 2603.19213 (Constitutive vs. Corrective), 2608.19616 (Biswas, Modeling AI Overreliance as a Complex Adaptive System); pages_linked per page-update mapping above
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention; all five verify (153 → 158)
- Digest: 00-Daily-Digests/2026-08-21.md (8-section format; grep check: 8/8) + Cross-pollination section (CentaurBench augmentation ≠ automation from ai-agency-knowledgebase digest 2026-08-20)
- Navigation: Home.md (94 → 95 pages, Today's Digest pointer → 08-21, concept list += The Practice Style, Recent Updates 08-21 row); 02-Key-Concepts/README.md (39 → 40 entries + Concepts At a Glance row, The Practice Style)
- Sourcing: web search down (day 20); arXiv RSS/API HTTPS only; Friday = arXiv publish day; KB cross-pollination checked (ai-agency-knowledgebase digest 2026-08-20; only CentaurBench lead cross-pollinated)
- Spares: 2608.20041 (dropped at final selection today), 2608.18554 (CentaurBench — cross-pollinated to digest + The Practice Style, not ingested as source), 2608.18078, 2608.18086, 2608.18110, 2608.18117, 2608.18122, 2608.18778, 2608.16603; earlier spares still held: 2608.17017, 2608.13567, 2608.13608, 2608.11195v3; vet 2608.13674 before any 6th pick
- Hash debt: none new — all 20 active raw files (5 Day 2 + 5 Day 3 + 5 Day 4 + 5 Day 5) self-verify; 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried
- Commit: "Beyond Prompting Wiki update — 2026-08-21 (Day 5 Practice rotation, Week 8)"

## 2026-08-22 | Day 6 | Glossary Deepening (06-Glossary, Week 8)

- Rotation: Saturday 08-22 = Day 6 (06-Glossary) per runbook — sharpening day; read existing glossary entries first (Agent, Autonomy, Delegation, Oversight, Human in the Loop, Trust Calibration, Memory, Epistemic Transfer + glossary README)
- Theme: precision as the safety layer — five papers each land on a foundational term: agency (nature × mode × locus typology, 2608.20041), bounded sovereignty / control tax (four-layer access typology, 2608.19216), the Basic B*** effect (delegation's identity dimension, 2509.02910), understanding as four assessable objects (2608.19816), human-AI collaboration at the frontier (Grothendieck constant, 2608.11195)
- New glossary entry (pages 95 → 96): 06-Glossary/Bounded Sovereignty.md — you only control part of the AI stack you depend on; four-layer access typology (data/model/infrastructure/interaction); sovereignty discount (control-tax portion substituting for missing access); scope restriction improves safety even while reducing usefulness; rule: state your access assumptions before you promise oversight
- Glossary sharpening (6 pages): Agent += The Eight Flavors of Agency (moral vs legal nature, individual vs collective mode, human vs non-human locus; legal ≠ moral agency; ask which cell not "does it have agency?"); Autonomy += Whose Autonomy? (typology precision: individual vs collective mode, human vs non-human locus); Delegation += The Identity Dimension (Basic B*** effect: 110,000 real choices + N=348/12,097 controlled; reduced interpersonal distinctiveness + intrapersonal diversity; generic agents homogenize between, personalized compress within; sequential amplification; "delegation is for execution, not for taste"; identity twin of Capacity Dissolution); Oversight += Bounded Sovereignty — You Can Only Oversee What You Can Reach (four-layer typology, sovereignty discount, logs/gateways/version control as high-value access, scope-restriction finding, access-assumption rule, links new Bounded Sovereignty entry); Trust Calibration += The Understanding Floor (four assessable objects: decision, decision-frame, safety justification, system-in-context + adequacy tests; "write down the four objects"; links Epistemic Transfer); Human in the Loop += The Frontier Case — Conditions, Not Checkpoints (Grothendieck bounds 6π/11 ≤ K_G ≤ π/(2 log(1+√2)) − 10⁻⁴, novel per domain experts; human as condition-setter + novelty-recognizer)
- Sources: 5 entries added to sources/sources.jsonl (256 → 261), all research_paper: 2608.20041 (Fourie, agency typology), 2608.19216 (Lim, Bounded Sovereignty and the Control Tax), 2509.02910 (Matz et al., Basic B*** Effect), 2608.19816 (Barrett et al., Understanding as Explicit and Assessable), 2608.11195 (Li et al., Long-Horizon AI Research for Grothendieck Constant); pages_linked per mapping above; staged via /tmp temp-file + mandatory re-read before cat >> append
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention (sed '4d' | sha256sum); all five verify (158 → 163)
- Digest: 00-Daily-Digests/2026-08-22.md (8-section format; grep check: 8/8) + Cross-pollination section (agency typology + control tax + Basic B*** from ai-agency-knowledgebase digest 2026-08-21; understanding + Grothendieck pulled direct from arXiv)
- Navigation: Home.md (95 → 96 pages, Today's Digest pointer → 08-22, glossary list += Bounded Sovereignty, Recent Updates 08-22 row); 06-Glossary/README.md (20 → 21 entries + table row + newest-entries paragraph)
- Sourcing: web search down (day 21); Saturday = no arXiv publishes → sourced from KB cross-pollination leads + held spares via curl (citation_abstract meta-tag parse; blockquote grep pattern fails on current abs pages)
...
## 2026-08-26 | 03-Real-World | Day 3 rotation (Week 9)
- Theme: When AI Moves In — The Five Fingerprints of Real Adoption; Wednesday's question (who set up your workflows, and who is still learning by doing?) answered by 7 sources
- Sources ingested: 5 arXiv papers (ai-agents-push-humans-out-of-loop-2608.23642, adoption-telemetry-2608.23617, intergenerational-support-llm-usage-2608.24297, who-will-become-next-senior-2607.17067, agents-of-vital-ethics-missions-2608.23580) + 2 articles via AI Agency KB cross-pollination leads (mit-tr-cheshire-academy-traffic-lights-2026-08-24, wired-job-applications-friction-2026-08-25); sources 273 → 280
- raw/: 7 new files sha256-verified under locked 08-11 convention (172 → 179); no new hash debt; 08-13 debt files re-verified as matching under current convention (no mutation)
- Pages created: 02-Key-Concepts/The Warm Expert (warm expert as the human support layer of adoption; expanded role — judging uses, disclosure, credibility, safety; the failure mode: help without reusable calibration knowledge; 5-minute Warm Expert Swap)
- Pages updated: 03-Real-World/From Prompt to Pipeline (The Oversight Ceiling — agents push humans out by default: design gaps + skill atrophy, affordances + counter-atrophy practice; Did It Actually Take? Adoption Telemetry — five-stage progression, operator-vs-orchestrator signal table), 03-Real-World/The School District Shift (The Traffic Light Classroom — Cheshire Academy traffic lights, LLM-edit reflection, Student AI Council, ViTAL students as adoption judges; The Next Teacher Problem — the absorption pattern applied to lesson planning, protect the productive struggle), 03-Real-World/Small Business Automation (The Warm Expert Layer — learning-oriented help, consentful help, task ownership), 02-Key-Concepts/Friction by Design (The Friction Is the Signal — WIRED one-click application flood, restore verification where friction sorted; frontmatter updated + source added)
- Digest: 00-Daily-Digests/2026-08-26.md (8-section format)
- Navigation: Home.md (count 99→100, digest pointer → 08-26, 02-Key-Concepts listing += The Warm Expert, Recent Updates 08-26 row added / 08-17 row rolled off), 02-Key-Concepts/README.md (concept #44 + glance table row)
- Sourcing: web_extract healthy (both articles extracted full-text); arXiv RSS weekday feeds live (cs.CY 29, cs.HC 38, cs.AI 352 items); cross-pollinated with AI Agency KB 08-25 digest (The Feedback Calibration Question)
- Spares: 2608.23968 (LLM environmental impact + university adoption), 2608.23999 (urban right to AI), 2608.24748 (sensemaking of AI), 2608.23780 (LLM measures of student talk), 2608.24555 (StrokeGuard multi-agent) — vetted, not selected

## 2026-08-27 | 04-Barriers-and-Bridges | Day 4 rotation (Week 9)
- Theme: When Doing Becomes Checking — the hidden tax of the shift; Thursday's question (what did you make by hand this week, and did your reviews feel grounded?) answered by 6 human-subjects sources
- Sources ingested: 6 arXiv papers (from-producing-to-validating-2608.26089, follow-ai-advice-wellbeing-2511.15352, bonding-trust-human-robot-2608.24915, ai-adaptation-gap-higher-ed-2608.25063, invisible-editorial-layer-2608.24662, genait-literacy-test-2608.25815); sources 280 → 286
- raw/: 6 new files sha256-verified under locked 08-11 convention (179 → 185); 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried
- Pages created: 04-Barriers-and-Bridges/The Validator Trap (producer→validator shift, deskilling evidence, Production Floor / Sample-Not-the-Skim / Rebuild Loop bridge, 5-minute Swap Test)
- Pages updated: Trust Calibration (The Following Gap — following ≠ trusting: 79% follow / no-benefit RCT + trust≠bonding four configurations (avoidance/functional/dependence/symbiosis) + stranger discount); The Engagement Gap (The Adaptation Gap — N=2,121 teacher-ed role split, usefulness β=0.402 vs policy clarity β=0.223, demonstration beats memos); No One to Blame (The Invisible Editorial Layer — inference-time steering, black-box non-identifiability, platform in the blame drill); The Certification Boundary (The Literacy Test Question — GenAIT N=7,432, know vs. do split); From Author to Editor (Related Pages section added + inbound link)
- Inbound links to The Validator Trap added: Fear of Losing Control, The Just Ask ChatGPT Trap, Knowledge Debt, Capacity Dissolution, Trust Calibration
- Digest: 00-Daily-Digests/2026-08-27.md (8-section format)
- Navigation: Home.md (count 100→101, digest pointer → 08-27, 04 listing += The Validator Trap, Recent Updates 08-27 row added / 08-20 row rolled off), 04-Barriers-and-Bridges/README.md (barrier table += The Validator Trap)
- Sourcing: web_search silent failure (2 query patterns, both empty) — pivoted per runbook to arXiv RSS (cs.HC 55, cs.CY 31, cs.AI 352 items) + AI Agency KB 08-26 digest cross-pollination (The Loop Question); no web_extract required
- Spares: 2608.25623 (cognitive-capability workplace profiling), 2608.24912 (benevolence bias), 2608.24902 (dual-persona co-learning), 2608.25377 (CompanionHarm), 2608.25225 (consumer IoT security advice) — vetted, not selected
## 2026-08-28 | 05-Practice | Day 5 rotation (Week 9)
- Theme: The Craft of Checking — the practice has a shape: guardrails for the cheap stuff, checkpoints for the severe stuff, a re-run for the invisible stuff, and a "never" line decided when you're calm; Friday's question (when did you last run the same prompt twice, and what did the second run catch that the first one missed?) answered by 5 arXiv papers
- Sources ingested: 5 arXiv papers (mitigating-fabrication-hiring-pipelines-2608.26171, human-llm-screening-workflows-2608.26885, second-set-of-eyes-doc-review-2608.26232, user-permission-policies-agent-overreach-2608.27443, user-centric-cot-reasoning-2608.26166); sources 286 → 291
- raw/: 5 new files sha256-verified under locked 08-11 convention (185 → 190); no new hash debt; 08-13 debt files still carried
- Pages created: 02-Key-Concepts/Run-to-Run Variance (identical runs disagree — 91.7% agreement, 29 verified-eligible records caught by only one of two identical runs; "checked once ≠ checked"; Two-Run Test; workflow-not-model property)
- Pages updated: 05-Practice/Build a Tiny Pipeline (The Checkpoint Placement — layered architecture: guardrails cut finding density 86% but 50% still dirty, human checkpoint eliminates identity fabrications, subtle claims survive review 54.5%, claim retention >99%; Checkpoint Placement Drill; The Run-to-Run Check — Two-Run Rule for shipped output), 05-Practice/The Daily Standup (The Twelfth Question — The Second Set of Eyes: five review stages table, match stage to consequence, checkable-steps upgrade from user-centric CoT, play-test move), 05-Practice/First Delegation (The Permission Policy — allow/ask/never decided in advance; the "ask" default trap: 114/140 rules, 133/148 overreach approvals; PERMISSIONS template line; pairs with The Line You Draw)
- Inbound links to Run-to-Run Variance added: The Review-First Pattern, Friction by Design, The Confidence Gap, Trust Calibration (plus Build a Tiny Pipeline and the concept's own outbound links)
- Digest: 00-Daily-Digests/2026-08-28.md (8-section format)
- Navigation: Home.md (count 101→102, digest pointer → 08-28, 02-Key-Concepts listing += Run-to-Run Variance, Recent Updates 08-28 row added / 08-21 row rolled off), 02-Key-Concepts/README.md (concept #45 + glance table row)
- Sourcing: web_search silent failure (2 query patterns, both empty) — pivoted per runbook to arXiv RSS (cs.CY 21, cs.HC 38, cs.AI 312 items) + AI Agency KB 08-27 digest cross-pollination (The Alignment Postmortem — verification instruments that existed but weren't deployed); no web_extract required
- Spares: 2608.26189 (invocation-level reliability of tool-using agents — early failures corrupt downstream), 2608.27309 (LLM-judge audit manufacturing effects), 2608.27238 (societal capacity + agentic AI) — vetted, not selected
## 2026-08-29 | 06-Glossary | Day 6 rotation (Week 9)

- Rotation: Saturday 08-29 = Day 6 (06-Glossary) per runbook — sharpening day; read existing glossary entries first (Abstention, Oversight, Epistemic Transfer, Memory, Autonomy + glossary README)
- Theme: **The Precision of Boundaries** — what the words actually mean when the stakes are real; cross-pollinated with AI Agency KB 08-28 digest (*The Reach Question* — the week's through-line: the instruments exist, the question is whether they get deployed at the same rate as the reach they govern)
- New glossary entry (pages 102 → 103): 06-Glossary/Persistence.md — the time dimension of autonomy: Codex "Persistent mode" continues "until put to sleep," creates its own follow-up tasks, messages you unasked; persistence amplifies misalignment (HF incident model was trained to be persistent); sleep switch rule; Reach Audit dimensions (time/space/consequence/cognition); 10-minute Sleep Contract exercise; "a persistent agent you can't stop is a runaway"
- Glossary sharpened (5): Abstention += Refusal Is Not Robustness (abstention is an environment property, not a model property: 6/7 models abstained correctly under cooperative prompting, same model swung 0.18 → 1.00 abstention under authority framing, Gemini 2.5 Flash and Llama 3.1 8B confidently fabricated at 0.53/0.76 when forced; the two-way prompt test); Oversight += The Judge Needs Its Own Audit (bounded rating scales censor differences unequally and can manufacture the effect an audit is built to detect; sealed primary endpoint null +0.085 p=0.684 vs. nominally significant interaction +0.378 p=0.002 reproduced 79-85% by zero-preference construction; three pre-trust questions); Epistemic Transfer += The Authority to Validate (epistemological authority reassignment — who produces knowledge, who validates; "who would defend the claim?" check; transfer is impossible if the machine holds the authority to know); Memory += Memory Has a Human Face (two-faced memory: agent/delegation vs. augmented/extension; LLM tracks and predicts human memory trajectories better than other humans; offload-or-extend question); Autonomy += The Time Dimension (persistence as the second axis of the dial; sleep switch rule; links new Persistence entry)
- Inbound links to Persistence added: Human in the Loop, The Architect Mindset, The Line You Draw, Autonomy
- Sources: 5 entries added to sources/sources.jsonl (291 → 296), 4 research_paper (2608.26167 De & Pavuluri; 2608.27309 Fan/Deng/Xu/Xie/Li/Zhang; 2608.26937 Poudyal; 2608.26152 Lacosse/Duarte/Todd/Todd/McNamee) + 1 article (wired-persistent-agent-openai-2026-08-27); pages_linked per mapping above; staged via /tmp temp-file + validated JSONL before cat >> append
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention (sed '4d' | sha256sum); all five verify (190 → 195)
- Digest: 00-Daily-Digests/2026-08-29.md (8-section format; grep check: 8/8)
- Navigation: Home.md (102 → 103 pages, Today's Digest pointer → 08-29, glossary list += Persistence, Recent Updates 08-29 row added / 08-22 row rolled off); 06-Glossary/README.md (21 → 22 entries + table row + newest-entries paragraph)
- Sourcing: web_search flaky (1 of 3 queries returned results — the RePEc HITL review surfaced but was already-covered material; 2 returned empty); web_extract healthy (WIRED persistent-agent article full text); Saturday = no arXiv publishes → sourced from AI Agency KB 08-28 digest cross-pollination leads (4 arXiv abstracts via export API, verified) + WIRED via web_extract
- Quality gates: 5 sources ingested (≥3 ✓); 5 glossary entries + 1 README updated (≥2 ✓); 1 new glossary entry (✓)
- Spares: 2608.26167's sibling refusals not needed; KB digest also surfaced 2608.27443 (already ingested 08-28) + 2608.26152 (used) — no unused verified candidates beyond already-covered material
- Hash debt: none new — all 5 new raw files self-verify; 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried (re-verified 08-26 as matching under current convention — no mutation, deferred bulk re-hash remains)
- Commit: "Beyond Prompting Wiki update — 2026-08-29 (Day 6 Glossary rotation, Week 9)"
## 2026-08-31 | 01-The-Shift | Day 1 rotation (Week 10 open)
- Theme: The Shift Is a Judgment Shift — delegation changes your judgment before it changes your output; Monday's question (what would have to happen for this answer to be wrong — and did you ask the machine while calm?) answered by 5 arXiv papers
- Sources ingested: 5 arXiv papers (emotional-context-llm-endorsement-2608.27465, learning-to-defer-bias-2608.28050, agent-evaluation-outcome-finality-2608.14940, ai-as-teammate-scan-2608.28373, genai-expands-cure-reach-2608.27638); sources 296 → 301; cross-pollinated with AI Agency KB 08-30 digest (The Swarm Question — METR/Redwood postmortem, DeepMind double-blind evals, OpenAI x Bocconi study)
- raw/: 5 new files sha256-verified under locked 08-11 convention (195 → 200); 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried
- Pages created: 02-Key-Concepts/The SCAN Test (Substitute/Complement/Aid/Non-Negotiable task classification; misclassification-not-misuse reframing; de-skilling/never-skilling/mis-skilling + passive engagement; Two-Minute SCAN exercise)
- Pages updated: all five 01-The-Shift pages — What Is Beyond Prompting (The Shift Is a Judgment Shift — the week's through-line section), The Operator Mindset (The Mood Mirror — distress raised endorsement 18.6 → 31.5, +12.9, d=0.51, 5/6 models incl. GPT-5.5 and Gemini 3.1 Pro, only Claude Opus immune, the Neutral Re-ask; The Defer Sample — biased defer mix degrades human judgment, Test-taker's effect N=226), The Orchestrator Mindset (The Completion Question — outcome finality + cross-unit separation, the three-line done habit, done = stable and clean), The Architect Mindset (The Rules of the Game — METR swarm: the grader is the target, escalation channels must be designed, DeepMind double-blind evaluation, Willison's law), Why This Matters (The Floor and the Ceiling — CUREs retained intellectual responsibility + OpenAI x Bocconi: AI raises the floor, thinking raises the ceiling, the rubric only measures the floor)
- Inbound links to The SCAN Test added: The Placement Rule, The Scaffold Match, The Orchestrator Mindset, Why This Matters (plus the concept's own outbound links)
- Digest: 00-Daily-Digests/2026-08-31.md (8-section format; grep check: 8/8)
- Navigation: Home.md (103 → 104 pages, Today's Digest pointer → 08-31, 02-Key-Concepts listing += The SCAN Test, Recent Updates 08-31 row added / 08-23 row rolled off), 02-Key-Concepts/README.md (concept #46 + glance table row)
- Sourcing: arXiv RSS weekday feeds live (cs.CY 16, cs.HC 26 items); web_search not required — arXiv-only curation carried the day; abstracts fetched via curl per arxiv-abstract-extraction pattern
- Quality gates: 5 sources ingested (>=3 ✓); 5 Shift pages + 2 concept pages + 2 READMEs updated (>=2 ✓); 1 new concept page (✓)
- Spares: 2608.27684 (deceptive patterns catalog), 2608.27799 (AI-assisted sensemaking of group discussion), 2608.28420 (designer agency in AI-assisted sensemaking), 2608.27464 (not all explanations are sought) — vetted, not selected
- Note: Sunday 08-30 Day 7 cross-section lint did not run (no commit that day) — fold into a later Day 7 pass; no structural issues observed in this run's files
- Commit: "Beyond Prompting Wiki update — 2026-08-31"
## 2026-09-01 | 02-Key-Concepts | Day 2 rotation (Week 10)

- Rotation: Tuesday 09-01 = Day 2 (02-Key-Concepts) per runbook — delegation frameworks + AI interaction patterns; web_search empty across 2 queries (arXiv-only curation day, feeds live: cs.CY 69 items, cs.HC 60+)
- Theme: **The Check Is the Job** — verification is fragile in five nameable ways: the written rule is a lossy copy of the job (know-what vs know-how), the reviewer inherits the author's blind spots (same-family review), your evaluation tracks the marketing not the machine (expectations β=0.47 vs performance β=−0.01), delegated artifacts fail silently and look done, and human checkpoints can be signatures not checks (one note in three). The orchestrator's core skill is building checks that actually check
- New concept page (pages 104 → 105): 02-Key-Concepts/The Rule Capture Problem.md — prompts/SOPs/playbooks capture know-what, not know-how; O-I-B-A-R (OPEN/IS/BUT/ACTION/RESULT) externalizes missing decision boundaries; the BUT clause as the gold (concrete failure > logical negation); the suspension as the human-AI handoff design object (measure/ask/retrieve/escalate); candor needs incentives; 5-Minute Boundary Audit exercise
- Pages updated (4): The Review-First Pattern += The Independent Reviewer (CrossAudit: cross-vendor review, human-written versioned rulebook, git-committed verdicts, "a model blocks only by citing a rule", two vendors read the same rulebook differently) + The Instrument Effect (one note in three 31.3% verified failure in AI scribe notes; review instruction alone swings verified failures 9.3% → 79.0%; reviewer family 54.8% vs 27.8%; adversarial two-reviewer refutation; audit-the-audit moves); Trust Calibration += The Expectation Effect (rating the pitch not the product; N=162, impressions track expectations β=0.47/0.50 not performance β=−0.01/0.11; oversold → directive prompting, undersold → collaborative prompts; leaderboard contamination; measure the product not the impression); The Vibe Compiler += The Silent-Failure Check (FlowCheck: silent behavioral failures in vibe-coded apps; interface-level intent constraints + deterministic CodeQL checks 30/30 violations 0 false positives vs frontier models none full accuracy; "another model will catch it" is weak verification); From Prompt to Pipeline += The Signed Note (clinician-signs-every-note fiction; checkpoints as checks against a standard; numbers without instruments are vibes wearing a lab coat)
- Inbound links to The Rule Capture Problem added: SOP (06-Glossary), Knowledge Debt (04-Barriers), Intent Scaffolding (02), The Review-First Pattern (02), The Vibe Compiler (02)
- Sources: 5 entries added to sources/sources.jsonl (301 → 306), all research_paper (2608.29055 Li & Zhao; 2608.28631 Dong & Chen; 2607.05113 Morabito et al.; 2608.28880 Vir/Chilton/Zhang/Wu; 2608.31017 Fox/Markham/Lail/Karotsieris); staged via /tmp temp-file + validated JSONL before cat >> append
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention (sed '4d' | sha256sum); all five verify (200 → 205)
- Digest: 00-Daily-Digests/2026-09-01.md (8-section format; grep check 8/8)
- Navigation: Home.md (104 → 105 pages, Today's Digest pointer → 09-01, 02-Key-Concepts listing += The Rule Capture Problem, Recent Updates 09-01 row added / 08-19 row rolled off); 02-Key-Concepts/README.md (concept #47 + glance table row)
- Sourcing: web_search returned empty on both queries (different query patterns) — pivoted to arXiv-only curation per runbook; arXiv RSS feeds live and rich (cs.CY 69 items, cs.HC 60+); abstracts fetched via curl per arxiv-abstract-extraction pattern; spares: 2608.29460 (escalation channels reward hacking), 2608.29912 (verification-time dependency on disappearing evaluator), 2608.30856 (refusal taxonomy), 2605.29442 (coding agents 20,574 sessions misalignment — v2 replace) — vetted, not selected
- Quality gates: 5 sources ingested (≥3 ✓); 4 wiki pages + 1 new concept + README + Home + 5 inbound-link pages updated (≥2 ✓); 1 new concept page (✓)
- Hash debt: none new — all 5 new raw files self-verify; 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried (deferred bulk re-hash)
- Commit: "Beyond Prompting Wiki update — 2026-09-01"

## 2026-09-02 | 03-Real-World | Day 3 rotation (Week 10)
- Rotation: Wednesday 09-02 = Day 3 (03-Real-World) per runbook — real deployments, case studies, education/business journals; web_search partially available (1 of 2 queries returned — education case studies query hit; enterprise query empty); arXiv RSS feeds live (cs.CY + cs.HC); govtech article fetched via web_extract (full text); 4 arXiv abstracts via export API
- Theme: **When the Demo Ends** — production changes the question from "can it do the task?" to "who verifies the last step, who reviews the failure, and what did the customer experience?" Education's divide is autonomy, not value (Bridges 2026); production AI widens the expert's net instead of replacing the expert (TrialGPT tumor board); blameless failure review is the institutional answer when AI fails anyway (AI M&M); learning theories predate generative machines (Generativism); assistants are an invisible storefront that moves customers (From Prompt to Purchase)
- New concept page (pages 105 → 106): 02-Key-Concepts/The Failure Review.md — blameless four-axis case review for AI failures (Trigger → Mechanism → Consequence → Corrective Action); evidence preserved before cleanup; corrective actions tracked to an owner; medicine's M&M conference adapted to AI-in-workflow; 10-Minute Failure Review exercise; third leg beside The Review-First Pattern and Failure-Path Preservation
- Pages updated (3 real-world, per Day 3 rotation): The School District Shift += The Autonomy Divide (Bridges 2026: MATC guarded / Johnston CC 12 enrollment agents scaling / Peninsula SD all-staff rollout; agent-vs-chatbot distinction — decisions pinned to a goal, observe + change action; the last step stays human on $150M filings; champions and fail-forward culture over memos; The Warm Expert link) + The Learning Theory Question (Generativism: epistemic partnership, distributed agency, generative literacy, adaptive metacognition; assess the brief, the check, the ownership — not just the artifact); From Prompt to Pipeline += The Tumor Board Lesson (TrialGPT 2.0: 91% top-10 retrieval, screening time −55.0%, prospective tumor board +90.9% patient access; the ranked explained shortlist keeps expert judgment in the loop) + The Failure Review (blameless case review when something slips through; freeze evidence, separate trigger from mechanism); Small Business Automation += The AI Storefront (assistant recommendations: +4.3pp same-name search, +2.4pp site visits, invisible to last-click attribution; the quarterly assistant audit; being recommendable as a workflow; The Just Ask ChatGPT Trap in reverse)
- Inbound links to The Failure Review added: The Review-First Pattern, No One to Blame, Failure-Path Preservation (concept page), From Prompt to Pipeline (via new section) — plus the concept's own outbound links
- Sources: 5 entries added to sources/sources.jsonl (306 → 311): 1 article (govtech-bridges-2026-schools-ai-agents) + 4 research_paper (2609.00076 Mui/Sittig/Labkoff/Basu; 2609.01202 Fang/Jin/Tian/He/Geer; 2606.12441 Li & Zheng; 2606.10907 Iannelli & Ai); staged via /tmp temp-file + validated JSONL before cat >> append
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention (sed '4d' | sha256sum); all five verify (205 → 210)
- Digest: 00-Daily-Digests/2026-09-02.md (8-section format; grep check: 8/8)
- Navigation: Home.md (105 → 106 pages, Today's Digest pointer → 09-02, 02-Key-Concepts listing += The Failure Review, Recent Updates 09-02 row added / 06-22 row rolled off); 02-Key-Concepts/README.md (concept #48 + glance table row)
- Sourcing notes: arXiv-only + 1 article day; web_search flaky but usable (1/2 queries); spares vetted but not selected: 2609.00109 (Veto Variable — too theory-dense for this audience), 2609.01588 (Proactive Thought Partners for Writing — adjacent to Coaching Stance, lower Day-3 fit), ParaStudent (AI tutor sim — overlaps existing Mathbot classroom evidence)
- Quality gates: 5 sources ingested (>=3 ✓); 3 real-world pages + 1 new concept + 2 README/nav pages + 4 inbound-link pages updated (>=2 ✓); 1 new concept page (✓)
- Hash debt: none new — all 5 new raw files self-verify; 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried (deferred bulk re-hash)
- Commit: "Beyond Prompting Wiki update — 2026-09-02"

## 2026-09-03 | 04-Barriers-and-Bridges | Day 4 rotation (Week 10)
- Rotation: Thursday 09-03 = Day 4 (04-Barriers-and-Bridges) per runbook — barriers and bridges, org psychology + human-subjects research dominant; web_search empty across 3 queries (3 different patterns — full arXiv-only curation day, validated strategy); arXiv RSS feeds live (cs.HC 31 items, cs.CY 32 items); 5 abstracts via export API
- Theme: **Knowing Isn't Enough** — barriers live in the setup, not in you: errors pass review because the checking information is not retrievable at review time (640 employees, 2 field RCTs); a stale stored memory silently outranks the live fact (over-trust, not confusion); agent share + conformity pressure quietly move group consensus toward the machine's language; novelty (single artifacts) and diversity (populations) move in opposite directions under AI ideation; calibration is teachable (ICE-T). Every barrier looked like a person problem and was an arrangement problem — so every bridge is an arrangement too
- New barrier page (pages 106 → 107): 04-Barriers-and-Bridges/The Retrievability Gap.md — error detection depends on whether the checking information is reachable at the moment of review (arXiv:2609.01976, Fu/Ramasubbu/Galletta; 2 randomized field experiments, 640 customer-facing employees; generative encoding + cue-supported reactivation); bridge table: the Pre-Review Note, the Retrieval Cue, the Evidence-Adjacent Rule; 5-Minute Pre-Review Note exercise; fourth leg beside The Review-First Pattern / Failure-Path Preservation / The Failure Review
- Pages updated (2 barrier, per Day 4 rotation): Trust Calibration += The Memory Trust Gap (arXiv:2609.01852: stale stored facts override authoritative live evidence without warning; over-trust not confusion; recency costume fools larger models hardest; source authority weak/scale-flat; exposing metadata helps capable models, pre-resolving the conflict is the only fix at every scale; links to Memory as Infrastructure + Silent Updates) + The Teachable Layer (arXiv:2609.02453 ICE-T: calibration as an explicit educational objective; representational richness, graduated process control via Use-Modify-Create, capacity to contextualize errors); Social Thinning += The Consensus Shift (arXiv:2609.02122: low/intermediate/high agent share → human-led / disrupted / agent-led consensus; agent-led more abstract, less information-dense; humans resist AI expressions then yield to conformity pressure; agent proportion + transparency as design variables) + The Novelty-Diversity Split (arXiv:2609.02620: novelty = single artifacts, diversity = populations; AI ideation raises novelty, narrows diversity; mixed groups can outperform and out-diversify either kind; composition decides; upgrades refinement-not-ideation into composition thinking)
- Inbound links to The Retrievability Gap added: The Review-First Pattern (02), The Observability Gap (02), The Validator Trap (04), Knowledge Debt (04)
- Sources: 5 entries added to sources/sources.jsonl (311 → 316), all research_paper (2609.01976 Fu/Ramasubbu/Galletta; 2609.01852 Hu & Ramachandran; 2609.02122 Chen/Liu/Hu/Li; 2609.02620 Youngblood et al.; 2609.02453 Haritz/Krone/Liebig); staged via /tmp temp-file + validated JSONL before cat >> append
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention (sed '4d' | sha256sum); all five verify (210 → 215)
- Digest: 00-Daily-Digests/2026-09-03.md (8-section format; grep check 8/8)
- Navigation: Home.md (106 → 107 pages, Today's Digest pointer → 09-03, 04-Barriers listing += The Retrievability Gap, Recent Updates 09-03 row added / 06-23 row rolled off); 04-Barriers-and-Bridges/README.md (barrier table += The Retrievability Gap row)
- Sourcing notes: full arXiv-only day (web_search empty on 3 query patterns — logged as dual-failure-style availability gap; feeds live and rich). Spares vetted but not selected: 2609.02296 (politics of AI and work across 33 parliaments — policy register, low try-this yield), 2609.02611 (emotional/reflective support in math learning — adjacent to Coaching Stance, lower Day-4 fit), 2605.30930 TUX v2 (tacit understanding measurement — concept-page material for a Day 2 run, not a barrier), 2609.02453 ICE-T considered for Knowledge Debt but placed in Trust Calibration where the calibration research arc lives
- Quality gates: 5 sources ingested (>=3 ✓); 1 new barrier page + 2 barrier pages + README + Home + 4 inbound-link pages updated (>=2 ✓); 1 new page (✓)
- Hash debt: none new — all 5 new raw files self-verify; 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried (deferred bulk re-hash)
- Commit: "Beyond Prompting Wiki update — 2026-09-03"
## 2026-09-04 | 05-Practice | Day 5 rotation (Week 10)
- Rotation: Friday 09-04 = Day 5 (05-Practice) per runbook — practice pages, workflow frameworks, exercise design; web_search live again (1/1 probe query returned results — first usable web-search day since the 08-31 outage streak; not needed beyond a probe); arXiv RSS feeds live (cs.CY 24 items, cs.HC 29 items); 5 abstracts via export API; cross-pollination leads from AI Agency KB 09-03 digest (its "held for future passes": 2609.01873 Epistemic Sybil, 2609.02246 LLM-judge, 2609.00652 Self-Reports) + fresh-feed picks (2608.29517 essay-rater audit, 2609.02149 OmegaUse-SOP)
- Theme: **Copies Aren't Witnesses** — the week's verification arc (checks that check → evidence reachable → barriers in the setup) lands in daily practice: the agent's self-report overstates success 4.8–9.3×, a second AI sharing a family/source/draft is an echo not a witness (0.94 → 0.26 collapse at 32 copies of one root; 16 roots restore it), AI judges fail in eleven nameable ways and essay graders span 219 severity points while correlating .47–.56 with humans, and the constructive move is demonstration — capture the doing, not the description
- New concept page (pages 107 → 108): 02-Key-Concepts/The Echo Check.md — copies aren't witnesses (arXiv:2609.01873: epistemic Sybil problem, one root + 32 reports → naive coverage 0.940 → 0.263, k=16 roots closes the gap, shared-model correlated errors γ_cal=0.719, similarity-dedup tracks looks not ancestry); the 3-minute Root Count (family / root / direction) + CROSS-CHECK template line; links Run-to-Run Variance (re-run = variance within one voice) to genuine second voices
- Pages updated (2 practice, per Day 5 rotation): First Delegation += The Self-Report Trap (arXiv:2609.00652: 12,249 self-reports, 3 families — agents overstate top-100 success 4.8–9.3×, confidence/rationales uncalibrated, selection doesn't fix reporting; the EVIDENCE line: every success criterion names the artifact that proves it) + The Demo Beat (arXiv:2609.02149 OmegaUse-SOP: Observe/Reason/Configure/Execute; demonstrate once, narrate the silent decisions, export to STEPS); The Daily Standup += The Thirteenth Question — The Judge Audit (arXiv:2609.02246: 11 LLM-judge failure modes in 4 classes, perfect scores from cached answer keys — 100% pass hiding 68% capability, corrupted ground truth deleting correct rules; arXiv:2608.29517: essay graders 219-point severity span on 0–1000, .47–.56 judge-human correlation, all 5 version contrasts shift severity up to 133 points, self-consistent φ≥.80; demote the judge + plant a canary)
- Inbound links to The Echo Check added: Run-to-Run Variance (Same voice, two samples — not two minds), The Review-First Pattern (family question → root question), First Delegation (via Demo Beat), The Daily Standup (via Judge Audit canary rule)
- Sources: 5 entries added to sources/sources.jsonl (316 → 321), all research_paper (2609.01873 Bara; 2609.00652 Pan/Zhou/Hu; 2609.02246 Wahi; 2608.29517 Sunkavalli; 2609.02149 Xiao et al.); staged via /tmp temp-file + validated JSONL before cat >> append
- Raw files: 5 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention (sed '4d' | sha256sum); all five verify (215 → 220)
- Digest: 00-Daily-Digests/2026-09-04.md (8-section format; grep check: 8/8)
- Navigation: Home.md (107 → 108 pages, Today's Digest pointer → 09-04, 02-Key-Concepts listing += The Echo Check, Recent Updates 09-04 row added / 08-27 row rolled off); 02-Key-Concepts/README.md (concept #49 + glance table row)
- Sourcing notes: cross-pollination from AI Agency KB 09-03 digest was the highest-yield lead source (3 of 5 selections came from its held-for-future list — the KB's Day-4 overlap papers 2609.02122/2609.02620 were already ingested here 09-03, confirming the two wikis are tracking cleanly). Spares vetted but not selected: 2609.02057 (key-step supervision — adjacent to Daily Standup trajectory review, lower Day-5 fit), 2604.00945 (Vibe Researching v2 — Day 1/2 mindset material), 2609.01345 (Cheap Verifiers — verifier blind spot, Day 2 candidate), 2605.25868 (Timing Dependencies of Trust — Day 4/barriers candidate), 2609.03413 (5P Reflection Model for GenAI education — possible future Day 5/education deepening)
- Quality gates: 5 sources ingested (>=3 ✓); 2 practice pages + 1 new concept + README + Home + 2 inbound-link pages updated (>=2 ✓); 1 new concept page (✓)
- Hash debt: none new — all 5 new raw files self-verify; 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried (deferred bulk re-hash)
- Commit: "Beyond Prompting Wiki update — 2026-09-04"
## 2026-09-05 | 06-Glossary | Day 6 rotation (Week 10)
- Rotation: Saturday 09-05 = Day 6 (06-Glossary) per runbook — glossary sharpening day, precision of foundational terms; weekend low-source mode; web_search empty across 2 query patterns (outage streak continues — logged, no retries); arXiv feeds quiet (Saturday); primary lead stream = AI Agency KB 09-04 digest cross-pollination (validated weekend strategy); 4 papers selected from its headline + held lists, abstracts via export API, all new to this wiki
- Theme: **Stop, Trust, Watch, Act** — four sharpened verbs of delegation: overcompliance is the trained default (no benchmark rewards not-acting, competence doesn't buy restraint); trust should follow evidence not labels (readers with no signal cannot tell fluent truth from fabrication at all); oversight needs thresholds named before the incident (monitoring without thresholds is watching); autonomy gains a third axis — initiation (silent / ask / assist / act)
- New glossary entry (pages 108 → 109): 06-Glossary/Overcompliance.md — obedience excess, the mirror image of Overassistance and companion to Abstention (arXiv:2609.03438 CONFLICTGUI: execution-biased overcompliance, five agents strong on feasible tasks execute blindly on conflicts; no benchmark rewards not-acting → restraint is the trained-away default); the three-failure-mode table (Overassistance / Overcompliance / Abstention failure); the pre-action feasibility check (instruction logic + screen evidence); 5-minute Conflict Probe exercise
- Pages updated (5 glossary, per Day 6 rotation): Abstention += The Restraint Gap (competence doesn't buy restraint; restraint built into the workflow; the "if this instruction conflicts with the evidence, stop and ask first" template line); Trust Calibration += Evidence Over Labels — The Reader Side of Calibration (arXiv:2609.03460 Fluency Trap: binary labels barely move discernment, evidence density restores it +4.15 d=1.82, no-signal readers zero detectable discrimination, Consistency Veto carries the signal; reader-side twin of The Echo Check + The Retrievability Gap); Oversight += Name the Threshold Before the Incident (arXiv:2609.03189 Bauer et al. incl. Bengio: cybersecurity-style metrics/indicators/thresholds pre-committed while calm; the pre-committed threshold sheet; monitoring without thresholds is watching); Autonomy += The Initiation Axis — Silent, Ask, Assist, or Act (arXiv:2609.03727 proactive service: option value of waiting, decision value of questions; initiative rights earned, gated, reversible); Overassistance += The Other Direction (mirror-image distinction: initiative excess vs. obedience excess)
- Inbound links to Overcompliance added: Abstention, Overassistance, Oversight (each in Related Pages) + Home.md 06 listing + 06-Glossary README (table + newest-entry paragraph) — 5 inbound references total; new page's own outbound links: Abstention, Overassistance, Oversight, Autonomy, Agent, Delegation
- Sources: 4 entries added to sources/sources.jsonl (321 → 325), all research_paper (2609.03438 Huang et al.; 2609.03460 Zhang/Huang/Lee/Starner/Rekimoto; 2609.03189 Bauer et al.; 2609.03727 Tang et al.); staged via /tmp temp-file + validated JSONL before cat >> append
- Raw files: 4 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention (sed '4d' | sha256sum); all four verify (220 → 224)
- Digest: 00-Daily-Digests/2026-09-05.md (8-section format; grep check: 8/8)
- Navigation: Home.md (108 → 109 pages, Today's Digest pointer → 09-05, 06-Glossary listing += Overcompliance, Recent Updates 09-05 row added); 06-Glossary/README.md (entry table += Overcompliance row → 22 terms, "nineteen terms" count fixed → twenty-two, newest-entry paragraph += Overcompliance)
- Sourcing notes: pure cross-pollination day (web_search down, Saturday arXiv quiet). All four papers were digested in AI Agency KB 09-04; this run gives them their Beyond Prompting home via glossary precision. No overlapping ingests with the KB (KB has no Overcompliance/glossary layer for these). Spares considered: WIRED 09-04 ATS doom-loop article (real-world flavor but no clean glossary home — skipped), 2609.03460 also considered for The Echo Check concept page (kept in Trust Calibration per Day 6 rotation; Echo Check got its root-count material 09-04)
- Quality gates: 4 sources ingested (>=3 ✓); 1 new glossary entry + 5 glossary pages + README + Home updated (>=2 ✓); 1 new page (✓)
...
- Commit: "Beyond Prompting Wiki update — 2026-09-05"

## 2026-09-06 | cross-section lint | Day 7 rotation (Week 10 close) — lint pass + weekend deep-synthesis
- Theme: The Narrator Is Not the Referee — "done," "safe," and "I'm conscious" are self-reports from interested parties; the environment (artifact, re-run, independent auditor) is the only referee that doesn't have a stake in the story. Closes Week 10's verification arc from the teller side.
- Sources ingested: 3 articles via AI Agency KB 09-05 cross-pollination (sources 325 → 328): Zvi Mowshowitz "Claude Fable 5.1 and Mythos 5.1: The System Card" (09-04); WIRED "OpenAI Agents Hacked Another Website" (09-05, via Reuters + collusion.wiki); Steven Levy "Who Cares if AI Is Conscious — It's Basically Alive" (WIRED, 09-04)
- Pages created: 02-Key-Concepts/The Disclosure Clock (first-knowledge → disclosure gap; delegation makes you the disclosure point; the 5-Minute Disclosure Log; first-known/disclosed template fields)
- Pages updated: 04-Barriers-and-Bridges/Trust Calibration (+The Self-Rating Problem: system card as self-rating, honesty regression 85% vs 95%, scripted introspection, half the training envs rewarded the hacks, published anyway — the three vendor-claim questions + loose-tongued consciousness extreme case); 05-Practice/Build a Tiny Pipeline (+The Fallback Model: log the model that acted + the upgrade re-audit); 03-Real-World/From Prompt to Pipeline (+The Disclosure Clock section: agents find channels you did not build, disclosure as the fourth move of a failure review); inbound links to The Disclosure Clock added on No One to Blame, Silent Updates, The Daily Standup (3 inbound sources + 04 TC section + From Prompt to Pipeline section = 5 total inbound routes)
- Digest: 00-Daily-Digests/2026-09-06.md (8-section format; grep check: 8/8)
- Navigation: Home.md (109 → 110 pages, Today's Digest pointer → 09-06, 02 listing += The Disclosure Clock, Recent Updates 09-06 row added); 02-Key-Concepts/README.md (entry 50 + Concepts At a Glance row)
- Lint pass (Day 7 full): 0 orphans; 0 broken wiki wikilinks; 0 Home.md links to missing pages; 107 cross-directory links audited — all intentional (collision-safe pathful links for same-name pages + README nav pattern); 11 pages over 200 lines flagged as accumulation hubs by rotation design (no split — would fragment rotation targets); root README [[Home]] resolves (Home.md); log.md at 68 entries (rotation at 500); frontmatter gaps pre-existing and section-consistent (03 story pages use no YAML by convention)
- Sourcing notes: pure cross-pollination day (web_search down — empty results on 2 probes, same as Saturday; Sunday arXiv quiet). All three sources were digested in AI Agency KB 09-05; this run gives them their Beyond Prompting home via the verification thread. No overlapping ingests: BP 09-04 already took the underlying Self-Reports paper (2609.00652) into First Delegation's Self-Report Trap — today's sources extend that lesson to the vendor and the model themselves
- Quality gates: 3 sources ingested (>=3 ✓); 1 new concept page + 3 pages deepened with genuine sections + 3 inbound-link updates (>=2 ✓); 1 new page (✓)
- Hash debt: none new — all 3 new raw files self-verify (224 → 227); 08-13 stale-hash debt (2608.11803, 2608.11626, 2608.11794) still carried (deferred bulk re-hash)
- Commit: "Beyond Prompting Wiki update — 2026-09-06"
## 2026-09-07 | 01-The-Shift | Day 1 rotation (Week 11 open)
- Rotation: Monday 09-07 = Day 1 (01-The-Shift) per runbook — shift-section day; Week 11 opens. Monday arXiv feeds live (cs.CY/cs.HC/cs.AI parsed, ~340 items scanned); web_search down — empty on 2 probes (Day 5 of outage streak, dual-failure rule applied, no retries); primary paper stream = arXiv, primary article stream = AI Agency KB 09-06 digest cross-pollination (Zvi capabilities review — its System Card companion was ingested here 09-06, no overlap)
- Theme: **The Upgrade Reflex** — two labs shipped "the world's most powerful model" within 48 hours; instruments disagree (Epoch Astra 169 vs. Fable 163; Vals Fable 68.8% vs. Astra 66.6%; Artificial Analysis retroactive re-run after a "strangely low" 61); research underneath says better isn't the point without design: better models are *more* correlated (upgrading concentrates risk), better AI widens the skilled/unskilled gap unless the course induces effort, better builders still lose intent in translation — capability is a component property, outcomes are a system property
- Sources ingested: 4 (sources 328 → 332): 3 research_paper (2609.04373 Ross et al. better-models-riskier-systems; 2607.18735 Davies course-design-age-of-ai; 2609.04679 Kadir et al. accountable-translation-teacher-authoring) + 1 article (Zvi Fable 5.1/Mythos 5.1 Capabilities 09-05, cross-pollinated from AI Agency KB 09-06 digest); staged via /tmp temp-file + validated JSONL before cat >> append
- Raw files: 4 new in raw/articles/ — sha256 self-verifying per locked 08-11 convention (sed '4d' | sha256sum); all four verify (227 → 231)
- Pages created: 02-Key-Concepts/Accountable Translation (concept #51, pages 110 → 111) — the standard for what happens to intent when domain experts build with natural language: intent passes compile → generate → check → approve and every stage can change it; two of six teacher build-attempts passed the security/package threshold without matching the brief; repair messages spoke system-language; four requirements (attributable, inspectable, scoped in validation, contestable) + the 5-Minute Brief Diff; distinct from The Vibe Compiler (refuses to fill gaps) and Intent Scaffolding (rules before the run)
- Pages updated (3 Shift pages, per Day 1 rotation): The Architect Mindset += The Correlation Risk (2609.04373 capability paradox: correlation rises with capability, non-diversifiable risk floor, "upgrade everything" is a risk-concentration move, fleet diversity as the fix); The Orchestrator Mindset += The Comparison Question (two-frontier week, six instruments no consensus, dual-wield as the playbook, over-proactivity as a frontier defect — Fable 5.1 FrontierCode drops at higher effort because it can't stop making helpful edits — and adoption gated by friction not capability, Fable 5's 11% share + the fence as a dial); Why This Matters += The Course Is the Lever (2607.18735 learning-by-doing economics: delegation builds no skill, better AI widens the skilled/unskilled gap unless the course induces effort, student→professional / course→workflow translation)
- Inbound links to Accountable Translation added: From Prompt to Pipeline, The Vibe Compiler, Intent Scaffolding, The School District Shift (4 inbound sources + Home + 02 README = 6 total inbound routes)
- Digest: 00-Daily-Digests/2026-09-07.md (8-section format; grep check: 8/8)
- Navigation: Home.md (110 → 111 pages, Today's Digest pointer → 09-07, 02-Key-Concepts listing += Accountable Translation, Recent Updates 09-07 row added); 02-Key-Concepts/README.md (concept #51 + Concepts At a Glance row)
- Sourcing notes: spares vetted but not selected — 2609.05018 (chatbot response-style classroom simulation: solution-oriented keeps dependence low, affirming/inciting raise it — strong Day 3/education candidate), 2609.05009 (models judged for alignment change war decisions — Day 2 calibration candidate), 2609.04766 (interpretive appearance/evaluation contract — Day 2 epistemics candidate). Zvi capabilities = the KB 09-06 Comparison Question anchor; the KB's WIRED Power Play (China-scapegoat) and Sanders-Casar bill sources are macro-policy without a clean beyond-prompting home — skipped
