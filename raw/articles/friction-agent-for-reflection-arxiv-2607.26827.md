...
- "Friction agent for reflection" vs. "smoothing agent for output" — fundamental reframing
- Removing friction removes reflection-in-action — the process by which designers build rationale
- Group ideation requires expressing and explaining ideas, not just generating them
- AI should support building and carrying rationale, not substituting for it

## Relevance

Directly extends and validates Friction by Design. Provides theoretical grounding for why friction matters: it's not about slowing down arbitrarily, it's about preserving reflection-in-action — the cognitive process through which people develop the rationale behind their choices. The paper explicitly argues against the industry default of "smooth = good."
