...
- 103 million application events from 1,017 employees across 8 organizations
- Day-to-day variation (44.6%) > individual differences (35.8%) > org variation (19.6%)
- Fragmentation rises over the week, resets after weekends
- Communication app use coincides with more fragmentation
- **GenAI use happens on more fragmented days BUT the period AFTER is marked by narrower, longer, more predictable app use**
- AI may help structure fragmented work rather than intensify it
