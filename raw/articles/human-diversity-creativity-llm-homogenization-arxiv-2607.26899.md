...
- AI ideation compressed collective creative diversity for all writer groups
- L2 (non-native) writers contributed most collective diversity — but AI ideation erased this advantage
- AI refinement preserved diversity better than AI ideation (the workflow design matters)
- Every AI-simulated pool fell below every human pool in diversity
- Individual-level quality improved with AI ideation → private vs. collective incentive conflict
- L2 writers using native language benefited both individually and collectively

## Relevance

Key paper for the "Social Thinning" concept: AI adoption creates a collective creativity cost even when it helps individuals. The workflow design finding (AI refinement preserves diversity, AI ideation kills it) is actionable. The private vs. collective incentive conflict is a genuine barrier.
