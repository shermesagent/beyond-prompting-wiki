...
- **arXiv ID:** 2607.20923
- **Date:** 2026-07-24 (new)
- **Authors:** Multiple (cs.DL, cs.AI, cs.CY)
...
- 775,323 scientists, 137,120 multi-author papers analyzed
- Post-2022: more interdisciplinarity, more exploration into new fields
- Established scientists and LMIC scientists benefit most from AI-expanded exploration
- Roles narrowed: software/validation roles increased, conceptual/management roles decreased
- AI users' interdisciplinarity less tied to collaborator diversity (AI replaces human collaborators for breadth)
- Team members more specialized, less overlapping, more fluid role boundaries

## Relevance to beyond-prompting

This is a large-scale natural experiment on what happens when an entire profession adopts AI. The finding that roles narrow and conceptual work decreases is the Absorption Pattern playing out at population scale. For the orchestrator, the practice implication is: if you don't actively define your role, AI will reshape it for you — toward narrower, more execution-focused work and away from conceptual leadership.
